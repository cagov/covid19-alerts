chart_tests = [
    ...
    {
        'nom':'SPARKLINE_CASES',
        'url':'http://static.covid19.ca.gov/img/generated/sparklines/sparkline-cases.svg?x=ii',
    ...
    },
    {
        ...
        'url':'http://static.covid19.ca.gov/img/generated/sparklines/sparkline-deaths.svg?x=jj',
        'pat':r'DATA_PUBLISHED_DATE:\s*(.*?)\s*,',
        'test_type':'DATE_MATCHES_TODAYSNOW',
    ...
    {
        'nom':'SPARKLINE_TESTS',
        'url':'http://static.covid19.ca.gov/img/generated/sparklines/sparkline-tests.svg?x=kk',
        'pat':r'DATA_PUBLISHED_DATE:\s*(.*?)\s*,',
        'test_type':'DATE_MATCHES_TODAYSNOW',
    ...
    },
    {
        ...
        'url':'http://static.covid19.ca.gov/img/generated/sparklines/sparkline-vaccines.svg?x=ll',
        'pat':r'DATA_PUBLISHED_DATE:\s*(.*?)\s*,',
        'test_type':'DATE_MATCHES_TODAYSNOW',
